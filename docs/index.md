...
FreeCAD model files, STEP export, and the full lines plan for offline use.

- [Design (FCStd)]({{ '/downloads/kb1.upwind.color.FCStd' | relative_url }})
- [Design (STEP)]({{ '/downloads/kb1.upwind.step.step' | relative_url }})
